...
public final class EPrimeReader {
    ...
    public class FunctionDescription {
        ...
        public ASTNode construct(ASTNode slot1, ASTNode slot2, ASTNode slot3, ASTNode slot4) {
            ...
            if(className.equals("MultiStageOnSolution")) {
                return new MultiStageOnSolution(slot1);
            }
            ...
            if(className.equals("MultiStage")) {
                return new MultiStage(slot1, slot2);
            }
            ...
            if(className.equals("AMOPB")) {
                return new AMOPB(slot1, slot2, slot3);
            }
